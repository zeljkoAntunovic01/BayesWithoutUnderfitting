...
import os
from alternating_projections_inference import loss_posterior_inference_2D_classifier_alt, loss_posterior_inference_MNIST_alt, proj_posterior_inference_2D_classifier_alt
